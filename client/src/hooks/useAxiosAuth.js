...
const useAxiosAuth = () => {
    ...
    useEffect(() => {
        ...
        const request = AxiosAuthInstance.interceptors.request.use((config) => {
        ...
        const response = AxiosAuthInstance.interceptors.response.use((response) => response, async (error) => {
